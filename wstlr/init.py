...
if version.parse(sys.version.split(" ")[0]) < version.parse("3.10"):
    try:
        ...
        die_if(True, f"""You are using python version, """
...
def exec(args=None):
    ...
    parser = ArgumentParser(description="""init-play will auto-generate """
    ...
    if args.modules != ['ALL'] and 'core' not in args.modules:
        print("""The module, core, is required for all other modules. Adding it to the list\n""")
